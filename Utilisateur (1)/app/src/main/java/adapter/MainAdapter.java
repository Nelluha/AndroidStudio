...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.ViewHolder> {
    ...
    //Création de layout (vignette) pour chaque item dans la liste animList

    @Override
    public ViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.vignette,parent,false));
    }
//Pour chaque layout crée on place les infos d'un anime
    @Override
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            //Renvoie vers la page de l'anime avec un click
            @Override
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            //Renvoie vers la page de l'anime avec un click maintenu
            @Override
...
//Pour chaque action effectué on verifie si le mode avion est activé
